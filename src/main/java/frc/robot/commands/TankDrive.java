...
public class TankDrive extends CommandBase {
    ...
    public void execute() {
        ...
        speed = j.getThrottle() * .1;
        turn = j.getTwist() * .1;

        //NEO RPM: 5676
        //CIM RPM: 5310

        lspeed = -speed; //+ turn;              //left speed slower when turned to left (neg turn values) //FIX ASAP
        rspeed = -(1.4 * speed);// - turn;  //right speed slower when turned to right (pos turn values)
