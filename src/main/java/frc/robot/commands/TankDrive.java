...
public class TankDrive extends CommandBase {
    ...
    public void execute() {
        ...
        lspeed = (1.25*x.getLeftY()); //+ turn;              //left speed slower when turned to left (neg turn values) //FIX ASAP
        rspeed = (x.getRightY());// - turn;  //right speed slower when turned to right (pos turn values)
