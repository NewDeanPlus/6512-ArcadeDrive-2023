...
armUp.whileTrue(sequence( m_p.moveRatchetF(),m_arm.moveArmUp()));//.whileFalse(m_arm.stopArm());
                        
final JoystickButton armDown = new JoystickButton(joystick1, 4);        
armDown.whileTrue(sequence( m_p.moveRatchetR(),m_arm.moveArmDown()));//.whileFalse(m_arm.stopArm());
