...
final JoystickButton clawOpen = new JoystickButton(joystick1, 1);
clawOpen.onTrue(m_p.moveClawF());

final JoystickButton clawClose = new JoystickButton(joystick1, 2);
clawClose.onTrue(m_p.moveClawR());

//Normal inefficient arm/elevator controls

final JoystickButton armUp = new JoystickButton(joystick1, 5);        
armUp.whileTrue(sequence( m_p.moveRatchetF(),m_arm.moveArmUp(ASpeedUp)));//.whileFalse(m_arm.stopArm());
                        
final JoystickButton armDown = new JoystickButton(joystick1, 6);        
armDown.whileTrue(sequence( m_p.moveRatchetR(),m_arm.moveArmDown(ASpeedDown)));//.whileFalse(m_arm.stopArm());

final JoystickButton elevUp = new JoystickButton(joystick1, 7);        
...
final JoystickButton elevDown = new JoystickButton(joystick1, 8);        
