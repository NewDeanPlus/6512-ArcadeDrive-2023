...
armUp.whileTrue(Commands.sequence( m_pn.moveRatchetF(),m_arm.moveArmUp()));
                        
final JoystickButton armDown = new JoystickButton(joystick1, 4);        
armDown.whileTrue(Commands.sequence( m_pn.moveRatchetR(),m_arm.moveArmDown()));
...
elevUp.whileTrue(m_elev.moveElevatorUp());
...
elevDown.whileTrue(m_elev.moveElevatorDown());
...
emergencyStop.whileTrue(Commands.parallel(m_arm.stopArm(), m_elev.stopElevator()));
