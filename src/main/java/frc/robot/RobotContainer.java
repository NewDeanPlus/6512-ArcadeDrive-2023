...
private final Joystick joystick1 = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand(m_arm, m_driveTrain, m_elev, m_pn));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_arm, m_driveTrain, m_elev, m_pn));
...
armUp.whileTrue(sequence( m_pn.moveRatchetF(),m_arm.moveArmUp()));//.whileFalse(m_arm.stopArm());
                        
final JoystickButton armDown = new JoystickButton(joystick1, 4);        
armDown.whileTrue(sequence( m_pn.moveRatchetR(),m_arm.moveArmDown()));//.whileFalse(m_arm.stopArm());
...
elevUp.whileTrue(m_elev.moveElevatorUp());//.whileFalse(m_elev.stopElevator());
...
elevDown.whileTrue(m_elev.moveElevatorDown());//.whileFalse(m_elev.stopElevator());
