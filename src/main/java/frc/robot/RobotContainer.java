...
private final Joystick joystick1 = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_driveTrain.setDefaultCommand(new TankDrive(m_driveTrain, joystick1));
...
armUp.whileTrue(new MoveArmUp(m_arm, joystick1).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton armDown = new JoystickButton(joystick1, 4);        
armDown.whileTrue(new MoveArmDown(m_arm, joystick1).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
